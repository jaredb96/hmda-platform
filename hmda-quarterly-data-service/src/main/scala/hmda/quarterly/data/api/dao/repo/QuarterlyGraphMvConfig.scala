...
object QuarterlyGraphMvConfig {
  ...
  // loan purpose home
  val APP_VOL_PERIODS_PURPOSE_PURCHASE: Seq[String] = config.getString("mv.app_vol_periods_purpose_p").split(",").toSeq
  val ALL_APP_VOL_PERIODS_PURPOSE_PURCHASE: Seq[String] = config.getString("mv.all_app_vol_periods_purpose_p").split(",").toSeq
  val CRED_SCORE_BY_LOAN_PERIODS_PURPOSE_PURCHASE: Seq[String] = config.getString("mv.cred_score_by_loan_periods_purpose_p").split(",").toSeq
  val CRED_SCORE_BY_RE_PERIODS_PURPOSE_PURCHASE: Seq[String] = config.getString("mv.cred_score_by_re_periods_purpose_p").split(",").toSeq
  val CLTV_BY_LOAN_PERIODS_PURPOSE_PURCHASE: Seq[String] = config.getString("mv.cltv_by_loan_periods_purpose_p").split(",").toSeq
  val CLTV_BY_RE_PERIODS_PURPOSE_PURCHASE: Seq[String] = config.getString("mv.cltv_by_re_periods_purpose_p").split(",").toSeq
  val DTI_BY_LOAN_PERIODS_PURPOSE_PURCHASE: Seq[String] = config.getString("mv.dti_by_loan_periods_purpose_p").split(",").toSeq
  val DTI_BY_RE_PERIODS_PURPOSE_PURCHASE: Seq[String] = config.getString("mv.dti_by_re_periods_purpose_p").split(",").toSeq
  val DENIAL_RATES_BY_LOAN_PERIODS_PURPOSE_PURCHASE: Seq[String] = config.getString("mv.denial_rates_by_loan_periods_purpose_p").split(",").toSeq
  val DENIAL_RATES_BY_RE_PERIODS_PURPOSE_PURCHASE: Seq[String] = config.getString("mv.denial_rates_by_re_periods_purpose_p").split(",").toSeq
  val INTEREST_RATES_BY_LOAN_PERIODS_PURPOSE_PURCHASE: Seq[String] = config.getString("mv.interest_rates_by_loan_periods_purpose_p").split(",").toSeq
  val INTEREST_RATES_BY_RE_PERIODS_PURPOSE_PURCHASE: Seq[String] = config.getString("mv.interest_rates_by_re_periods_purpose_p").split(",").toSeq
  val TLC_BY_LOAN_PERIODS_PURPOSE_PURCHASE: Seq[String] = config.getString("mv.tlc_by_loan_periods_purpose_p").split(",").toSeq
  val TLC_BY_RE_PERIODS_PURPOSE_PURCHASE: Seq[String] = config.getString("mv.tlc_by_re_periods_purpose_p").split(",").toSeq
